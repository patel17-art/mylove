	    ...
	    Garden.options = {
	        ...
	        growSpeed: 1000 / 60,
	        color: {
				rmin: 150,   // Minimum red value (for pink, purple, blue)
    			rmax: 255,   // Maximum red value (for pink, purple)
    			gmin: 50,    // Minimum green value (adjust for pink, purple, blue)
    			gmax: 180,   // Maximum green value (adjust for pink, purple, blue)
    			bmin: 100,   // Minimum blue value (for pink, purple)
    			bmax: 255,   // Maximum blue value (for purple, blue)
    			opacity: 0.1 // Opacity for the flowers
	        },
	        tanAngle: 60
	    };
